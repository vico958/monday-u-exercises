    ...
    export const TodoItem = ({callBackFunction, todo, errorCallBackFunction}) => {
        ...
        <div className = {styles.list_item}>
            <input className = {styles.list_item_checkbox_status} type = "checkbox" onChange={onChangeCheckBox}
            checked = {isCompleted}/>
            <div className = {styles.item_text_as_div} onClick = {onClickEditItem}>{task}</div>
        <img className = {styles.list_item_edit_button} src={edit_icon} onClick = {onClickEditItem}/>
        <img className = {styles.list_item_delete_button} src = {delete_icon} onClick={onClickDeleteButton}/>
        </div>
        </section>
    );
    }
